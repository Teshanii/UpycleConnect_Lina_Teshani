<?php
  ...
  function envoyer() {
    ...
    if (document.getElementById('titre').value.trim() === '') {
        document.getElementById('msg').innerHTML = '<div class="alert alert-danger">Le titre est obligatoire.</div>';
        return;
    }
    if (document.getElementById('description').value.trim() === '') {
        document.getElementById('msg').innerHTML = '<div class="alert alert-danger">La description est obligatoire.</div>';
        return;
    }
