#  Script d'installation pour UpcycleConnect
#  Lance les conteneurs Docker et charge la base de demonstration.
...
#Attendre que la base MySQL soit prete
...
#Charger la base remplie de demonstration
